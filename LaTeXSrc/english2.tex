...
\item[否定分句后面附加补充分句]
  ...
  \item I haven't finished, but \'you H\`AVE. [附加肯定分句]
...
\item[否定分句后跟赞同否定]
  \begin{itemize}
  \item ``He doesn't know Russia.'' ``N\`O, he D\`OESn't.''
  \end{itemize}

\item[either 和 too]
  \begin{itemize}
  \item She won't notice \unbf{any} change in you, \unbf{either}.
  \item She will notice \unbf{some} change in you, \unbf{too}.
  \end{itemize}
\end{description}
