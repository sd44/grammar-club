...
这句话选择用非事实的虚拟语气来说，是为了以缓和委婉的口吻劝对方不事。
...
\item  例 1： If I \unbf{were} you, I \unbf{wouldn't do} it.
  ...
  当然，我不可能是你，所以不能用叙述事实的语气 I am you来表达。\textbf{虚拟语气是用
    动词的过去形态来表示“非事实”，因此用 I were you来表示。连带在主要从句中
    也用过去形态但不代表过去时间的 would来表示非事实，而成为 wouldn't do 的动
    词形态。}
