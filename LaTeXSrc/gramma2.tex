...
状语从句是最简单的从属从句，由完整的简单句外加有意义的、表达逻辑关系的连接词
...
\item I know \unct{that I am right}{O连接词 + 名词从句}.
  ...
  我知道我对。
\item I know \unct{this}{O} \unct{because}{连接词} \unct{I have proof}{状语从句}.
...
试比较下面句子：
\begin{enumerate}
\item \unct{Whatever (= No matter what) he may say}{状语从句}, \unct{I}{S} \unct{won't change}{V} \unct{my mind}{O}.
...
再看看 whichever：
\begin{enumerate}
\item \unct{Whichever (=No matter which) way you go}{状语从句},
