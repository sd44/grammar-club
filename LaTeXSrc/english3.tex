...
\item[主语和动词的倒装] SVC 和 SVA 类型的分句大部分有必不可缺的第三成分，因为
  ...
  动词上，有可能造成语义不清，如：
  \begin{description}
  \item[SVC] The sound of the bell \unbf{grew} \unbf{faint}.
  \item[CSV] \unbf{Faint} the sound of the bell \unbf{grew}. [不清晰，有可能误解为逐渐变小的铃声
    变大grew （louder）]
  \item[CVS] \unbf{Faint} \unbf{grew} the sound of the bell. [有矫揉造作感。]
  \end{description}
  还有：
  \begin{description}
  \item[SVA] The Squidward’s hopes and dreams \unbf{lies} \unbf{here}.

    章鱼哥的希望和梦想埋葬（躺）在这里。尾重，突出here。

  \item[AVS] \unbf{Here} \unbf{lies} the Squidward’s hopes and dreams. [尾重，
  ...
  日常对话有些倒装句：
  \begin{description}
  \item[AVS] \unbf{Here} \unbf{comes} my brother.

  \item[AVS] \unbf{Down} \unbf{came} the rain.
  \item[AVS] \unbf{Up} \unbf{went} the flag.
  \end{description}
...
\item[主语和功能词的倒装]
  ...
  \item[so, neither, nor]
    \begin{itemize}
    \item John saw the accident and \unbf{so} \unbf{did} Mary. [Mary did so]
    \item She wasn't angry and \unbf{neither} \unbf{was} I. [I wasn't, either]
    \item She must come and \unbf{so} \unbf{must} you. [you must come too]
    \end{itemize}
  \end{description}
\end{description}
