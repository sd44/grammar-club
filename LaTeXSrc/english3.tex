...
修饰语可以是\index{概念!限制性修饰语}\index{概念!非限制性修饰
  语}
\begin{description}
...
\item[非限制性修饰语] 非限制性修饰语提供的是\textbf{附加的、非关键性的信息}。
  ...
  类似起非限制性修饰语作用的分句也被叫做\textbf{非限制性定语分句}。\index{概
    念!非限制性定语从句}
\end{description}
...
\item \sout{I won't see \unbf{anyone}, \unbf{who has not made an appointment}.}
