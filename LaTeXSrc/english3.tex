...
\item[wh- 假拟分裂句] Wh+ 主语 + 谓语 + 其他成分 + BE + \textbf{focus}
 ...
 \item[关系分句] \ul{What you’ll find} is unbf{that people who lie down with
     dogs will get up with fleas}, my boy.

   你会发现近墨者黑，我的儿子。（改编自西方谚语，字面意思是跟狗躺在一块儿的人，会和跳
   蚤一起起床。）

   \ul{What I didn’t like} was \unbf{leaving my mum}.

  \end{description}

  wh- 分句可以和焦点的位置颠倒：
  \begin{itemize}
  \item \unbf{Send a complaint to Radio 2} is \ul{what I did}.

  \item \unbf{Leaving my mum} was \ul{what I didn’t like}.
  \end{itemize}
\end{description}
