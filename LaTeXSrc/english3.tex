...
\item[同位分句] 同位分句中\textbf{只能是that}，不能用wh-代词替
  代，\textbf{that也不构成分句成分}。名词短语中心词应是一个\textbf{概括性抽象
    名词}，例如fact, idea, proposition, reply, remark, answer 等等。
  \begin{itemize}
  \item The news \unbf{that the team had won} calls for a celebration.
...
\item It was a mixture \unbf{consisting} of oil and vinegar.
  ...
  that consisting of的省略，不能说是that was consisting（静态动词）的缩写。
\end{itemize}
