...
only) 修饰时，充当关系分句\textbf{主语}的关系代词通常是 \textbf{that}，充当宾
...
与 -ing 和 -ed分句不同，不定式分句所对应关系分句中的关系代词除了可以是\textbf{分句主
...
由不定式分句作同位后置修饰语\textbf{可能没有对应的同位限定性分句}，而只有一个
介词短语和它相对应：
\begin{itemize}
...
\subsubsection{后置的形容词}
\label{subsubsec:inversionadj}

形容词后置有三个类型：
\begin{description}
\item[复合词] -thing, -body, -one结尾的不定代词和以 -where结尾的副词，其
  本身不可分拆； what else, who next等词的强粘性，使形容词倾向于被“挤出”后置。
  \begin{itemize}
  \item Anybody \unbf{younger} would have done better. [Any younger one]
  \end{itemize}

\item[有后置修饰语或补足语的形容词] 名词短语中，前置修饰语（
  ...
  \item a mistake \unbf{typical of beginners}
    ...
    写作时如要前置，可加连字符hyphen：a typical-of-beginners mistake
  \end{itemize}
