...
\textbf{有的句子混合了假设条件句和陈述句：假设句为假设，用假设条件语法；另一
  陈述句为事实、非假设，用普通语法，不要生搬硬套。}例如：
...
各介词表示的空间关系可见\cref{fig:preppic}。其实不止是空间，这些介词在表示其
他方面时往往也有类似维度上的侧重。
...
\item[in] 二维或三维内部
  \begin{itemize}
  \item in a garden/town/country/pool

  \item in a line/row/queue, in the front/sky/sun, in a letter/picture/photo
  \end{itemize}

\item[at] 点
  \begin{itemize}
  \item at a window/bus stop， at traffic lights, at the door（门口）

  \item at reception in a hotel, at the entrance to the hotel

  \item at the top/bottom/end,
  \end{itemize}

\item[on] 在面上
  \begin{itemize}
  \item on the floor/grass, on a river/road/coast, on the door/wall, on your
    nose

  \item on the bottle/door 在瓶子/门（面）上，on the left/right side/hand

  \item on a map/computer/website/photo
  \end{itemize}
...
\item[时间位置 at, on, in, by]
  ...
  \item[at] 时间点和节假日
    \begin{itemize}
    \item at 6:30 pm, at the Christmas, at

    \item 有些时间段被当作时间点来考虑，如：

      at noon/night/weekdens, at the weekend, at the/that/lunch/breakfast
      time
...
\item[过去或将来时间段]
  ...
  \item[杂项] 如下：
    \begin{taskitem}
    * on time 准时
    * in time 及时， 反义词是too late
    * in the end = finally，反义词 at first
    * at the end of the month/the game/January
    * at/on the corner of a street
    * in the corner of a room
    * at home/work/school/university/meeting(家校工作)
    * in hospital/prison/jail/bed
    * at/in a restaurant/theatre/hotel
    * at the station/airport/doctor's
    \end{taskitem}
...
\item[主语] \unbf{That he passed the exam} surprised everyone.
  ...
  \textbf{作为主语的 that- 从句中，that 不可省略}，否则句子结构混乱、
  易产生歧义，。
...
\item[不能引导to不定式] He didn't tell us whether/\xout{if} to wait for him \emph{or} (to) go on without him.
\end{description}
