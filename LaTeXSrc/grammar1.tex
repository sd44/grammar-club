...
\item[递差 (GRADIENCE)] \index{概念!递差 gradience} 英语中常常有两个或多个类
  别之间相近，彼此之间有着不同 程度级别的差异（级差）。
...
football team at the time 这个名词性关系从句的省略。其中 who代表马丁·韦尔斯，
...
定式（to V）与动名词（Ving）可以当做名词使用，来取代词从句。所以：
\begin{itemize}
...
how, when(ever), who(ever), what(ever), which(ever)，但没有先行词（这也是他
们被称为自由关系从句的原因）。在很多方面,它们更像是名
词短语。
